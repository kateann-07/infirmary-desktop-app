...
public class InfirmarySystemApplication {
    public static void main(String[] args) {
        ...
        System.out.println("7 - Add Student Personal Record");
        ...
        switch (choice) {
            ...
            case 7: {
                StudentMedicalRecordFacade.CreateMedicalRecordsFacade createMedicalRecordsFacade = new StudentMedicalRecordFacadeImpl.CreateMedicalRecordsFacadeImpl() {
                    @Override
    ...
    private static void addStudentMedicalRecord(Scanner scanner, StudentMedicalRecordFacade.CreateMedicalRecordsFacade recordsFacade) {
        System.out.println("Adding Student Personal Record");
        Student.StudentMedicalRecords record = new Student.StudentMedicalRecords();
